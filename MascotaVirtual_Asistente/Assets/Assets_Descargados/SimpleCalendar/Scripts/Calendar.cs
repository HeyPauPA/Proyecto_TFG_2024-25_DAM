...
namespace SimpleCalendar
{
    public class Calendar : MonoBehaviour
    {
        ...
        /// <summary>
        /// The current month the user has selected.
        /// </summary>
        private int selectedMonth = DateTime.Now.Month;
        /// <summary>
        /// The current year the user has selected.
        /// </summary>
        ...
        */
        ...
        /// <summary>
        /// Adds the names of the days of the week (sunday, monday, tuesday, etc) to the table. 
        /// Changing the startingweekday in the editor is implemented in this function
        /// </summary>
        ...
        {
            calenderTitle.text = CultureInfo.CurrentCulture.DateTimeFormat.GetMonthName(selectedMonth) + " " + selectedYear;
        }
